...
namespace ByteBank.Forum.App_Start.Identity
{
    public class SenhaValidador : IIdentityValidator<string>
    {
        ...
        //O "=>" é um Arrow Operator, ele é como se fosse um return direto, como essa função só retorna um valor, é melhor usar o arrow no lugar de um return
        private bool VerificaTamanhoRequerido(string senha) =>
            //O "?" utilizado, verifica se a senha é null, se for, ele já retorna false, é a mesma ideia do if (senha == null) return false
